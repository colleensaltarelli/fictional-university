...
add_action('rest_api_init', 'university_custom_rest');
  ...
  function university_files() {
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBeU1O0AwFo1Z2tk7b2InbKk3RpWA_GhAU', NULL, microtime(), true);
  ...
  function universityMapKey($api) {
    $api['key'] = 'AIzaSyBeU1O0AwFo1Z2tk7b2InbKk3RpWA_GhAU';
    return $api;
  }
